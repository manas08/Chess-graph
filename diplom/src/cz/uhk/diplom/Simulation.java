...
public class Simulation {
	...
	public void setBoard(List<Vertex> kone, List<Vertex> vertices, List<Edge> edges, Image obrazek, MainWindow main,
			int mode) {
		this.kone = kone;
		...
		kun.setX1(this.vertices.get(0).getX1() + 35);
		kun.setY1(this.vertices.get(0).getY1() + 38);
		this.kun.setRow(1);
